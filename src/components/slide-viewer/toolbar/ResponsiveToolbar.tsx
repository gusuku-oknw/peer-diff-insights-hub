...
import ModeSelector from "@/components/slide-viewer/toolbar/ModeSelector";
import ModeSpecificActions from "@/components/slide-viewer/toolbar/ModeSpecificActions";
