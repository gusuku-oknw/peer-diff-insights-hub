...
const PricingSection = () => {
  ...
  return (
    <section id="pricing" className="py-20 gradient-secondary">
          ...
          {plans.map((plan, index) => (
            <Card 
              ...
              className={`relative transition-all duration-300 hover:scale-105 ${plan.color} ${
                plan.popular ? 'shadow-2xl' : 'hover:shadow-lg'
              }`}
            >
              {plan.popular && (
              ...
              <CardHeader className="text-center pb-8">
                ...
                <div className="flex items-baseline justify-center gap-1">
                  <span className="text-4xl font-bold gradient-primary bg-clip-text text-transparent inline-block">
                    {plan.price}
                  </span>
