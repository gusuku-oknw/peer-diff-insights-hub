      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            革新的な機能で
            <span className="gradient-primary bg-clip-text text-transparent inline-block px-0 text-4xl">
              レビューを再定義
            </span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => <Card key={index} className={`${feature.color} border-0 transition-all duration-300 hover:scale-105 hover:shadow-lg`}>
              <CardHeader>
